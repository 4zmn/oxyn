  ...
  lvim.builtin.treesitter = {
    ...
    highlight = {
      ...
      disable = function(lang, buf)
        ...
        local status_ok, large_file_detected = pcall(vim.api.nvim_buf_get_var, buf, "fourshvim_large_file_disable_treesitter")
        return status_ok and large_file_detected
      end,
    },
...
function M.setup()
  ...
  if not ts_status_ok then
    ts_status_ok, treesitter_configs = pcall(require, "nvim-treesitter.config")
  end
  if not ts_status_ok then
